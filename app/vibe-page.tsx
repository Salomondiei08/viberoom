...
export default function VibePage() {
  ...
  return <main className="site-shell">
    ...
    <section className="creator-section section-pad"><div className="creator-copy"><div className="section-kicker">CRÉÉ ET ANIMÉ PAR</div><h2>Salomon<br /><em>AI & Code.</em></h2><p>Je construis avec l’IA, je teste des produits et je partage mes retours en direct. VibeRoom est mon espace pour découvrir les projets de la communauté.</p><a className="button button-coral" href="https://www.tiktok.com/@salomondiei" target="_blank" rel="noreferrer">Voir mon TikTok <ArrowUpRight size={16} /></a></div><div className="creator-profile-card"><blockquote className="tiktok-embed" cite="https://www.tiktok.com/@salomondiei" data-unique-id="salomondiei" data-embed-from="oembed" data-embed-type="creator"><section><a target="_blank" rel="noreferrer" href="https://www.tiktok.com/@salomondiei?refer=creator_embed">@salomondiei</a></section></blockquote><div className="creator-profile-fallback"><div className="creator-avatar">S</div><div><strong>Salomon | AI and Code</strong><span>@salomondiei</span></div><a href="https://www.tiktok.com/@salomondiei" target="_blank" rel="noreferrer" aria-label="Ouvrir le TikTok de Salomon">↗</a></div></div></section>
