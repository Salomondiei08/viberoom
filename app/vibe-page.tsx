...
export default function VibePage() {
  ...
  return <main className="site-shell">
    ...
    <footer className="footer section-pad"><div className="brand-lockup"><span className="brand-mark"><span /></span><span>VIBE<span className="brand-accent">ROOM</span></span></div><span>Les projets vibe-coded, en direct.</span><span>© 2026 VibeRoom</span></footer>
  </main>;
}
